...
public final class ViewSplashscreen1Binding implements ViewBinding {
  @NonNull
  ...
  private ViewSplashscreen1Binding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static ViewSplashscreen1Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ViewSplashscreen1Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.view_splashscreen1, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ViewSplashscreen1Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ViewSplashscreen1Binding((LinearLayout) rootView, imgSplashscreen1,
