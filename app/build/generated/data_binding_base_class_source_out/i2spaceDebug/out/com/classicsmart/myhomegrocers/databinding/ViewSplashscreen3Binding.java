...
public final class ViewSplashscreen3Binding implements ViewBinding {
  @NonNull
  ...
  private ViewSplashscreen3Binding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static ViewSplashscreen3Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ViewSplashscreen3Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.view_splashscreen3, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ViewSplashscreen3Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ViewSplashscreen3Binding((LinearLayout) rootView, imgSplashscreen1,
