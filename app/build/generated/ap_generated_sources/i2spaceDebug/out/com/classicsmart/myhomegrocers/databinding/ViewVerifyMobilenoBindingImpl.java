...
public class ViewVerifyMobilenoBindingImpl extends ViewVerifyMobilenoBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.btnChangeNumber, 6);
        sViewsWithIds.put(R.id.txt_show_phone_number, 7);
    }
    // views
    @NonNull
    ...
    public ViewVerifyMobilenoBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }
    private ViewVerifyMobilenoBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
