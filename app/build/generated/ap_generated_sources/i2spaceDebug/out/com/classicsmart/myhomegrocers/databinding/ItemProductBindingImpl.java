...
public class ItemProductBindingImpl extends ItemProductBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.txt_discount, 1);
        sViewsWithIds.put(R.id.im_product, 2);
        sViewsWithIds.put(R.id.txt_product_name, 3);
        sViewsWithIds.put(R.id.txt_quantity, 4);
        sViewsWithIds.put(R.id.rb_product_ratting, 5);
        sViewsWithIds.put(R.id.txt_price, 6);
        sViewsWithIds.put(R.id.im_share, 7);
        sViewsWithIds.put(R.id.im_fav, 8);
        sViewsWithIds.put(R.id.txt_goto_cart, 9);
    }
    // views
    @NonNull
