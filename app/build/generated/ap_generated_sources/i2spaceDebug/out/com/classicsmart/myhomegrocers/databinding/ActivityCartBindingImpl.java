...
public class ActivityCartBindingImpl extends ActivityCartBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.Imgview, 2);
        sViewsWithIds.put(R.id.tv_empty, 3);
        sViewsWithIds.put(R.id.rv_getcart, 4);
        sViewsWithIds.put(R.id.rl_bottom, 5);
        sViewsWithIds.put(R.id.tv_checkout, 6);
        sViewsWithIds.put(R.id.tv_pricedetails, 7);
        sViewsWithIds.put(R.id.tv_total_cart_price, 8);
    }
    // views
    @NonNull
